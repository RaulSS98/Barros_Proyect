...
@Service
public class SubSalonServiceImpl {
    ...
    public SubSalon modifySubSalon(Integer id , SubSalon subSalon) throws Exception {
        if(subSalonRepository.findById(id) != null){
            subSalonRepository.delete(subSalonRepository.getById(id));
            return subSalonRepository.save(subSalon);
        }
        else{
            throw new Exception("El ID del subsalon que se desea modificar no existe");
        }
    }
    ...
    public String deleteSubSalon(Integer id){
        if(subSalonRepository.findById(id) != null){
            ...
            return "Subsalon borrado. ID: " + id;
        }
        return "El ID del subsalon que se desea borrar no existe";
    }
    ...
    public SubSalon getSubsalon(Integer id) throws Exception {
        if(subSalonRepository.findById(id) != null){
            ...
            throw new Exception("El ID del subsalon que se desea buscar no existe");
        }
    }
}
